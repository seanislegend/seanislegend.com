...
const RootLayout = async ({children}: {children: React.ReactNode}) => (
    <html
        lang="en"
        className="flex flex-grow flex-col bg-white antialiased dark:bg-black md:min-h-full"
    >
            ...
            <div className="relative z-[100] flex-shrink-0 flex-grow-0 px-4 md:flex md:w-[260px] md:flex-grow md:flex-col lg:w-[300px]">
                ...
                <div className="hidden flex-grow flex-col justify-between space-y-8 md:flex">
                    ...
                    <footer className="hidden md:sticky md:bottom-0 md:block">
                        <div className="absolute bottom-6 z-50 hidden h-10 w-full bg-gradient-to-t from-white via-white to-transparent transition duration-200 ease-out dark:from-black dark:via-black md:block" />
                        <SiteFooter />
                    </footer>
                </div>
            </div>
