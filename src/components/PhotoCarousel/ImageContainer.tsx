    ...
    return (
        <div ref={$container} className="relative flex w-full md:h-auto md:flex-grow">
            <div
                key={activeIndex}
                className={clsx(
                    'mx-auto h-full w-full flex-shrink-0 animate-fadeIn md:absolute md:left-1/2 md:top-1/2 md:block md:-translate-x-1/2 md:-translate-y-1/2 -sm:!h-full -sm:!w-full',
