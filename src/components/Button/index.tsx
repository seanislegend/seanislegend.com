...
const Button: React.FC<React.PropsWithChildren<Props>> = ({children, href, ...props}) => {
    const className = `inline-block bg-gray-100 px-5 py-3 text-[10px] uppercase tracking-[0.5px] text-gray-700 underline-offset-4 transition duration-200 ease-out hover:bg-gray-200 hover:underline md:text-xs md:font-semibold md:tracking-[1px] dark:bg-gray-900 inline-flex items-center space-x-2 dark:text-white dark:hover:bg-gray-800 ${
        props.className || ''
    }`;
