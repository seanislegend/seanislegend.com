...
const PhotoThumbnail: React.FC<Props> = ({
    ...
    >
        ...
        {label && (
            <span className="mt-2 block break-normal font-serif text-sm uppercase text-[var(--dimmed-text)] transition duration-200 ease-out group-hover:text-[var(--link-text)] group-hover:underline group-hover:underline-offset-2">
                {label}
            </span>
        )}
    </Link>
