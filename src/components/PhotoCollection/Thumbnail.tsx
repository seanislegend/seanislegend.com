    ...
    <Condition
        ...
        wrapper={children => (
            ...
            >
                ...
                />
                {linksTo==='collection'&&(
                    <span className="absolute bottom-2 right-2 h-full w-full overflow-hidden">
                        <span className="absolute bottom-0 right-[2.5rem] z-40 h-[2.25rem] translate-x-full bg-[var(--button-bg-hover)] px-4 py-2 pr-0 text-sm font-medium uppercase text-[var(--button-text)] transition duration-300 ease-in-out group-hover/photo:translate-x-0 group-hover/photo:duration-200 min-[1320px]:block hidden">
                        ...
                        <span className="absolute bottom-0 right-0 z-40 h-7 w-7 sm:h-[2.25rem] sm:w-[2.5rem] bg-[var(--button-bg-hover)] p-1 sm:p-2 text-[var(--button-text)]">
